...
class shapeBuilder(tk.Canvas):
    def __init__(self, root, sb_sm):
        ...
        self.e1 = tk.Entry(self.sb_sm, width = 10,bg=root.colors["entry_color"], fg=root.colors["text_color"],insertbackground=root.colors['text_color'])
        self.e2 = tk.Entry(self.sb_sm, width = 10,bg=root.colors["entry_color"], fg=root.colors["text_color"],insertbackground=root.colors['text_color'])
